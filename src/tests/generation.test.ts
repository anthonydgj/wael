...
test('should generate geometries', () => {
    ...
    expect(result.geometry.geometries.map((f: any) => f.geometry.coordinates)).toStrictEqual([[0, 0], [0, 0], [0, 0]]);
    ...
    expect(result).toBeTruthy();
    expect(result.geometry.geometries.map((f: any) => f.geometry.coordinates)).toStrictEqual([[1, 1], [0, 0], [-1, -1]]);
...
test('should generate with function count provider', () => {
    ...
    expect(result).toBeTruthy();
    expect(result.geometry.geometries.map((f: any) => f.geometry.coordinates)).toStrictEqual([[1, 1], [1, 1], [1, 1]]);
...
test('should exclude undefined values', () => {
    ...
    expect(result).toBeTruthy();
    expect(result.geometry.geometries.map((f: any) => f.geometry.coordinates)).toStrictEqual([[0, 0], [2, 2], [4, 4]]);
